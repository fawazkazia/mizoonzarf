...
export const HOMEPAGE_SECTION_DEFS: HomepageSectionDef[] = [
  ...
  { key: "adBanner", label: "Advertisement Banner (currently between Style Finder & Women's Collection)" },
  { key: "runningBanner", label: "Running Banner (between Women's & Style Finder)" },
  { key: "kidsFeature", label: "Kids Collection" },
  { key: "adBanner2", label: "Advertisement Banner 2 (currently between Kids & Style For Every Generation)" },
  ...
  { key: "brandStripTop", label: "Brand Banner (above Newsletter)" },
  { key: "brandStripBottom", label: "Brand Banner (below Newsletter)" },
