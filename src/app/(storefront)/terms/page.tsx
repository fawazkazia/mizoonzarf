  ...
  return (
    <Container className="mx-auto max-w-2xl py-16 text-ink-soft">
      ...
      <div className="mt-8 flex flex-col gap-5 text-sm leading-relaxed">
        <p>By using the {settings.brandName} website, you agree to these terms. Prices are shown in {settings.currency} and are inclusive/exclusive of GST as noted at checkout.</p>
