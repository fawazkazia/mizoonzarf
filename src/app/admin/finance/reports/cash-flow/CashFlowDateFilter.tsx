...
export function CashFlowDateFilter({ activePreset, from, to }: { activePreset: DatePreset | null; from: string; to: string }) {
  ...
  function setPreset(preset: DatePreset) {
    ...
    params.delete("from");
    params.delete("to");
    router.push(`/admin/finance/reports/cash-flow?${params.toString()}`);
  }
