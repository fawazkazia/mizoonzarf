...
export function ReportsDateFilter({ activePreset, from, to }: { activePreset: DatePreset | null; from: string; to: string }) {
  ...
  function setPreset(preset: DatePreset) {
    ...
    params.delete("from");
    params.delete("to");
    router.push(`/admin/customer-care/reports?${params.toString()}`);
  }
